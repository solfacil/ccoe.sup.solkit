...
class EntityModelFactory:
    ...
    def integer_id(cls, auto_increment: bool = True) -> type[EntityModel]:
        ...
        class DynamicIntegerIdModel(EntityModel):
            ...
            id: Mapped[int] = mapped_column(
                Integer, primary_key=True, index=True, nullable=False, unique=False, autoincrement=auto_increment
            )
    ...
    def uuid_id(cls, as_uuid: bool = True) -> type[EntityModel]:
        ...
        class DynamicUUIDIdModel(EntityModel):
            ...
            id: Mapped[UUID] = mapped_column(
                UUID(as_uuid=as_uuid), primary_key=True, default=uuid.uuid4, index=True, nullable=False, unique=False
            )
    ...
    def multi_column_id(cls, columns: tuple[str, ...]) -> type[EntityModel]:
        ...
        class DynamicCustomIdModel(EntityModel):
            __abstract__ = True
            __table_args__ = PrimaryKeyConstraint(*columns, name=f'pk_{"_".join(columns)}')
